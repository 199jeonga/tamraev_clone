  ...
  return (
    <div id="infoBox">
      ...
      <div className="info_content_area">
        <p>
          하지만 막상 전기차를 렌트해서 이용하더라도<br />전기차만의 특성을 모르고 이용하거나 특별한 기능을 사용하지 못한다면<br />즐거운 여행 기간 동안 오히려 예상치 못한 어려움을 만날 수 있습니다.
          </p>
        <p>
        ...
        <span>'탐라는 전기차에서 준비한 꿀팁들로 전기차에 대해 간단하게 알아보며 더욱 더 즐거운 여행을 준비해 볼까요?</span>
